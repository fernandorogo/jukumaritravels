...
const Proveedores = () => {
  ...
  const getData = async (pageCurrent) => {
    ...
    setProveedores(data.proveedores.docs);
  ...
  const saveProveedor = async () => {
    try {
      ...
      Swal.fire({
        icon: 'success',
        title: 'El proveedor ha sido registrado con exito',
  ...
  const fetchProveedores = async () => {
    ...
    .catch(response => response.error('Error fetching proveedores:', error));
  ...
  const handleSearch = (e) => {
    ...
    const filtered = proveedores.filter((proveedor) => seacrchFields.some((field) => String(proveedor[field]).toLowerCase().includes(searchText.toLowerCase())
    )
    );
      ...
      <div className='container container-flex card Larger shadow mt-3'>
        <div className="card-header d-flex justify-content-between align-items-center">
          ...
          <div>
            ...
            }} title="Haga clic para agregar un nuevo proveedor">< i className="fa-solid fa-plus fa-beat "></i></button>
          </div>
        </div>
            ...
            <table className='table table-bordered border-1 table-hover mt-2'>
              ...
              <thead>
                <tr style={{ background: "#008cba", color: "#ffffff" }}>
                  ...
                  <th scope="col" className="responsive-text">Tipo Doc</th>
              ...
              <tbody>
                {Array.isArray(filteredProveedores) && filteredProveedores.map((item, i) => (
                  <tr key={item._id}>
                    ...
                    <td>
                      <div className="btn-group btn-group-sm" role="group">
                        ...
                        <span className='btn btn-danger d-flex align-items-center'
                          onClick={() => deleteProveedor(item._id)} title='Elimiar'
